...
input string CustomComment = "Strategy_2_10_139";
...
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 175)
...
string sqStrategyName = "Strategy 2.10.139";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqOpen("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3+1));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 175);
