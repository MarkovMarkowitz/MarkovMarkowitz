//+------------------------------------------------------------------+
//| Strategy 4.33.110 - Optimization 0.8.866_Profit_53.4K EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader4
//|    Generated at 12/24/2023 22:01
//| 
//|    Backtested on EURUSD_M1 / H1, 2003.05.05 - 2022.04.07 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_4_33_110_Opt._0_8_866";
...
input int KCBarCloseserPeriod1 = 19;        //KCBarCloseserPeriod1
input int WPRCrossPeriod1 = 34;        //WPRCrossPeriod1
input int WPRCrossPeriod2 = 18;        //WPRCrossPeriod2
input double MoveSL2BECoef1 = 0.95;        //MoveSL2BECoef1
input double ProfitTarget1 = 168.98;        //ProfitTarget1
input double StopLoss1 = 202;        //StopLoss1
input int Period1 = 37;        //Period1
...
input int MinimumPT = 125;   //Minimum PT in pips
...
#define WILLIAMSPR_1 1     //iCustom(NULL,0, "SqWPR", WPRCrossPeriod1)
#define WILLIAMSPR_2 2     //iCustom(NULL,0, "SqWPR", WPRCrossPeriod2)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", Period1, PRICE_LOW)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 15)
#define LOWEST_1 5     //iCustom(NULL,0, "SqLowest", Period1, PRICE_HIGH)
...
string sqStrategyName = "Strategy 4.33.110 - Optimization 0.8.866_Profit_53.4K";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqClose("NULL",0, 2) < sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 2));

     ShortEntrySignal = (sqClose("NULL",0, 2) > sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 2));

     LongExitSignal = (((NormalizeDouble((double) sqOpen(NULL,0, 1), 6) < NormalizeDouble((double) sqDaily(NULL,0, "High", 1), 6))
      &&   crossesDown(WILLIAMSPR_1, 1, -50.0))
      &&   crossesDown(WILLIAMSPR_2, 2, -20.0));

     ShortExitSignal = (((NormalizeDouble((double) sqOpen(NULL,0, 1), 6) > NormalizeDouble((double) sqDaily(NULL,0, "Low", 1), 6))
      &&   crossesUp(WILLIAMSPR_1, 1, -50))
      &&   crossesUp(WILLIAMSPR_2, 2, -80));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[WILLIAMSPR_1] = iCustom(NULL,0, "SqWPR", WPRCrossPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[WILLIAMSPR_2] = iCustom(NULL,0, "SqWPR", WPRCrossPeriod2);
