...
input string CustomComment = "Strategy_2_46_159";
...
input double ProfitTarget1 = 8;        //ProfitTarget1
...
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 2.46.159";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqOpen("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2+1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 2) + (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 2) - (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
