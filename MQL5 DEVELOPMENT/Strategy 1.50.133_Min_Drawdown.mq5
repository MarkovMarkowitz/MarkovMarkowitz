...
input string CustomComment = "Strategy_1_50_133";
...
input int ExitAfterBars1 = 26;        //ExitAfterBars1
...
string sqStrategyName = "Strategy 1.50.133";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqOpen("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1+1));
