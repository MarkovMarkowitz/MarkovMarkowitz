//+------------------------------------------------------------------+
//| Strategy 1.69.108 EA
//|
//|    Generated by StrategyQuant 3.9.132 for MetaTrader
//|    Generated at 05/20/2021 13:34
//| 
...
input string CustomComment = "Strategy 1.69.108";
...
input int IchimokuSnkSpnCrsBshTnkPrd1 = 57;        //IchimokuSnkSpnCrsBshTnkPrd1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2.3)
#define KELTNERCHANNEL_2 1     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 2.0)
#define KELTNERCHANNEL_3 2     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 2)
#define KELTNERCHANNEL_4 3     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 1.5)
#define ICHIMOKU_1 4     //iCustom(NULL,0, "SqIchimoku", IchimokuSnkSpnCrsBshTnkPrd1, IchimokuSnkSpnCrsBshKjnPrd1, IchimokuSnkSpnCrsBshSnkPrd1)
#define BOLLINGERBANDS_1 5     //iBands(NULL,0, BollingerBandsPrd1, 0, 2.0, PRICE_CLOSE)
#define BOLLINGERBANDS_2 6     //iBands(NULL,0, BBRangePeriod1, 0, 1.9, PRICE_CLOSE)
#define BOLLINGERBANDS_3 7     //iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.69.108";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqClose("NULL",0, 1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1))
      &&   sqIsRising(KELTNERCHANNEL_2, 2, false, 2, 0));

     ShortEntrySignal = ((sqClose("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1))
      &&   sqIsFalling(KELTNERCHANNEL_3, 2, false, 2, 1));

     LongExitSignal = (sqIsRising(KELTNERCHANNEL_4, 2, false, 2, 0)
      &&   sqIchimokuSenkouSpanCross(-1, NULL,0, ICHIMOKU_1, 2, 0));

     ShortExitSignal = (sqIsFalling(KELTNERCHANNEL_4, 2, false, 2, 1)
      &&   sqIchimokuSenkouSpanCross(1, NULL,0, ICHIMOKU_1, 2, 0));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_1, 1 + 1, 3) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 2)))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_3, 0 + 1, 3) - (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 2)))), "Current");
      sl = sqFixMarketPrice(0, "Current");
      pt = sqFixMarketPrice(0, "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2.3);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_2] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 2.0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_3] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_4] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 1.5);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBRangePeriod1, 0, 1.9, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE);
