...
input string CustomComment = "Strategy_2_40_114";
...
#define LOWEST_1 2     //iCustom(NULL,0, "SqLowest", Period1, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 2.40.114";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqOpen("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2+1));
