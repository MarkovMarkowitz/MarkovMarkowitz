...
input string CustomComment = "Strategy_3_56_159";
...
input double StopLoss1 = 10;        //StopLoss1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2.0)
#define KELTNERCHANNEL_2 1     //iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2)
#define EMA_1 2     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_OPEN)
...
string sqStrategyName = "Strategy 3.56.159";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqClose("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_2, 0, 1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(EMA_1, 0, 2) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2.0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_2] = iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2);
