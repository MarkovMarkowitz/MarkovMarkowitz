...
input string CustomComment = "Strategy 2.51.101";
...
input int MACDMainCrossZroFst1 = 8;        //MACDMainCrossZroFst1
input int MACDMainCrossZroSlw1 = 26;        //MACDMainCrossZroSlw1
input int MACDMainCrossZroSmt1 = 113;        //MACDMainCrossZroSmt1
...
#define MACD_1 1     //iMACD(NULL,0, MACDMainCrossZroFst1, MACDMainCrossZroSlw1, MACDMainCrossZroSmt1, PRICE_CLOSE)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BBRangePeriod1, 0, 2.0, PRICE_MEDIAN)
#define BOLLINGERBANDS_2 3     //iBands(NULL,0, BBRangePeriod1, 0, 2, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 2.51.101";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqClose("NULL",0, 1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1));

     ShortEntrySignal = (sqClose("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1));

     LongExitSignal = crossesDown(MACD_1, 3, 0, 0);

     ShortExitSignal = crossesUp(MACD_1, 3, 0, 0);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqLow(NULL,0, 1) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3)))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 35);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqHigh(NULL,0, 1) - (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 3)))), "Current");
      sl = sqFixMarketPrice(0, "Current");
      pt = sqFixMarketPrice(0, "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBRangePeriod1, 0, 2.0, PRICE_MEDIAN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBRangePeriod1, 0, 2, PRICE_MEDIAN);
