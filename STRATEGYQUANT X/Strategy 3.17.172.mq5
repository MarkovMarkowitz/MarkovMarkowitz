//+------------------------------------------------------------------+
//| Strategy 3.17.172 EA
//|
//|    Generated by StrategyQuant X Build 138 for Tradestation
//|    Generated at 01/04/2024 21:51
//| 
//|    Backtested on @EW / M60, 2009.01.02 - 2018.08.30 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_3_17_172";
...
input int ADXChangesUpPeriod1 = 40;        //ADXChangesUpPeriod1
input double ProfitTarget1 = 405;        //ProfitTarget1
...
#define ADX_1 0     //iCustom(NULL,0, "SqADX", ADXChangesUpPeriod1)
...
string sqStrategyName = "Strategy 3.17.172";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = changesUp(ADX_1, 1, 0);

     ShortEntrySignal = changesUp(ADX_1, 1, 0);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqHigh(NULL,0, 0), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqLow(NULL,0, 0), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[ADX_1] = iCustom(NULL,0, "SqADX", ADXChangesUpPeriod1);
