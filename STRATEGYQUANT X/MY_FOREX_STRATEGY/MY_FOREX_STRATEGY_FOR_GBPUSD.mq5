//+------------------------------------------------------------------+
//| Strategy 3.74.197 EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader4
//|    Generated at 01/05/2024 20:07
//| 
//|    Backtested on GBPUSD_M1 / H1, 2003.05.05 - 2018.08.30 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_3_74_197";
...
input int MACDMainSlow1 = 10;        //MACDMainSlow1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2.5)
...
string sqStrategyName = "Strategy 3.74.197";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqClose("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1))
      &&   (sqGetIndicatorValue(MACD_1, 2)>-0.2));
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2.5);
