//+------------------------------------------------------------------+
//| Strategy 2.31.184 EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader5 (hedged)
//|    Generated at 01/05/2024 18:31
//| 
//|    Backtested on EURUSD_M1 / H1, 2013.09.01 - 2018.09.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_2_31_184";
...
input int BBBarClosesPeriod1 = 113;        //BBBarClosesPeriod1
...
#define PARABOLICSAR_1 0     //iCustom(NULL,0, "SqParabolicSAR", 0.011, 0.20)
#define MOVINGAVERAGE_1 1     //iMA(NULL,0, MABarClosesPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_CLOSE)
#define PARABOLICSAR_2 3     //iCustom(NULL,0, "SqParabolicSAR", 0.011, 0.2)
...
string sqStrategyName = "Strategy 2.31.184";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqGetBid("NULL") < sqGetIndicatorValue(PARABOLICSAR_1, 2))
      &&   (sqClose("NULL",0, 2) < sqGetIndicatorValue(MOVINGAVERAGE_1, 2)))
      &&   (sqClose("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3)));

     ShortEntrySignal = (((sqGetBid("NULL") > sqGetIndicatorValue(PARABOLICSAR_2, 2))
      &&   (sqClose("NULL",0, 2) > sqGetIndicatorValue(MOVINGAVERAGE_1, 2)))
      &&   (sqClose("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3)));
...
bool initIndicators(){
   ...
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.011, 0.20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarClosesPeriod1, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_2] = iCustom(NULL,0, "SqParabolicSAR", 0.011, 0.2);
