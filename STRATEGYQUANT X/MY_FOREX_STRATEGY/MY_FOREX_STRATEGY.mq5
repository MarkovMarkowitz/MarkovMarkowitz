...
input string CustomComment = "Strategy_2_23_108";
...
input int MACDMainFast1 = 24;        //MACDMainFast1
input int MACDMainSlow1 = 52;        //MACDMainSlow1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 1.1)
#define MACD_1 1     //iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE)
#define MOVINGAVERAGE_1 2     //iMA(NULL,0, MABarClosesPeriod1, 0, MODE_SMMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 2.23.108";
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 1.1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_1] = iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarClosesPeriod1, 0, MODE_SMMA, PRICE_CLOSE);
