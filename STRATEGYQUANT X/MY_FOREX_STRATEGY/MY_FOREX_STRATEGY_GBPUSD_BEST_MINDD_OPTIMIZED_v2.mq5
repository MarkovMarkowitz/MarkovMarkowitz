//+------------------------------------------------------------------+
//| MY_FOREX_STRATEGY_GBPUSD_BEST_OPTIMIZED_MINDD - Optimized 0.13 EA
//|
...
input int BBBarOpensPeriod1 = 23;        //BBBarOpensPeriod1
input double ProfitTarget1 = 190.59;        //ProfitTarget1
input double StopLoss1 = 12.01;        //StopLoss1
input double PriceEntryMult1 = 1.83;        //PriceEntryMult1
...
string sqStrategyName = "MY_FOREX_STRATEGY_GBPUSD_BEST_OPTIMIZED_MINDD - Optimized 0.13";
