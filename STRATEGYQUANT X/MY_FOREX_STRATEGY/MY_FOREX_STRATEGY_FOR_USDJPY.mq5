//+------------------------------------------------------------------+
//| Strategy 2.96.190 EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader5 (hedged)
//|    Generated at 01/05/2024 15:15
//| 
//|    Backtested on USDJPY_M1 / H1, 2013.09.01 - 2018.09.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_2_96_190";
...
input int KCerPeriod2 = 30;        //KCerPeriod2
input int MACDMainFast1 = 8;        //MACDMainFast1
input int MACDMainSlow1 = 17;        //MACDMainSlow1
input int MACDMainSmooth1 = 9;        //MACDMainSmooth1
input double ProfitTarget1 = 180;        //ProfitTarget1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 2.5)
#define KELTNERCHANNEL_2 1     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod2, 2.0)
#define MACD_1 2     //iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE)
#define KELTNERCHANNEL_3 3     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod2, 2)
...
string sqStrategyName = "Strategy 2.96.190";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling(KELTNERCHANNEL_1, 2, false, 3, 1)
      &&   sqIsFalling(KELTNERCHANNEL_2, 2, false, 3, 1))
      &&   sqIsRising(MACD_1, 2, false, 3));

     ShortEntrySignal = ((sqIsRising(KELTNERCHANNEL_1, 2, false, 3, 0)
      &&   sqIsRising(KELTNERCHANNEL_3, 2, false, 3, 0))
      &&   sqIsFalling(MACD_1, 2, false, 3));
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 2.5);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_2] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod2, 2.0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_1] = iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_3] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod2, 2);
