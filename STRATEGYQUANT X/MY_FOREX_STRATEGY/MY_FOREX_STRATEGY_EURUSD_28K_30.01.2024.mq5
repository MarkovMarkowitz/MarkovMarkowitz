//+------------------------------------------------------------------+
//| Strategy 1.18.154 EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader5 (hedged)
//|    Generated at 01/30/2024 11:26
//| 
//|    Backtested on EURUSD_M1 / H1, 2017.01.03 - 2022.03.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_1_18_154";
...
input int IchimokuKjnSenCrsBshSnkPrd1 = 52;        //IchimokuKjnSenCrsBshSnkPrd1
input double PriceEntryMult1 = 0.9;        //PriceEntryMult1
input double ProfitTarget1 = 5;        //ProfitTarget1
input double StopLoss1 = 6;        //StopLoss1
...
input string FridayExitTime = "14:30";
...
#define ICHIMOKU_1 0     //iCustom(NULL,0, "SqIchimoku", IchimokuKjnSenCrsBshTnkPrd1, IchimokuKjnSenCrsBshKjnPrd1, IchimokuKjnSenCrsBshSnkPrd1)
...
string sqStrategyName = "Strategy 1.18.154";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIchimokuKijunSenCross(1, NULL,0, ICHIMOKU_1, 3, 2);

     ShortEntrySignal = sqIchimokuKijunSenCross(-1, NULL,0, ICHIMOKU_1, 3, 2);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Open", 1) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 71);
